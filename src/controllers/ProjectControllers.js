...
export const postProject = async (req, res) => {
    ...
    try {
      ...
      const {ProjectName,ProjectDescription,StartDate,EndDate,Priority,Budget,ProjectStatus}= req.body;
  
      if (! ProjectName || !ProjectDescription || !StartDate || !EndDate || !Priority || !Budget || !ProjectStatus ) {
     ...
     const newProject = await ProjectModel.create({ProjectName,ProjectDescription,StartDate,EndDate,Priority,Budget,ProjectStatus});
